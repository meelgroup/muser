...
// ANTON: setting this to 1 will disable abort traps when melted literals are
// added to the solver. This is very dangerous, and can be used only when you
// know that the literals have not been *actually* eliminated.
#define UNSAFE    1
