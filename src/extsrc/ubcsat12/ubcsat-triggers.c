...
void AddDataTriggers() {
  ...
  // ANTON: replaced with the custom one
  ...
  // ANTON: removed ReadCNF and InitVarsFromFile from DefaultProcedures and 
  // DefaultProceduresW because I'm doing initialization myself
  CreateContainerTrigger("DefaultProcedures","LitOccurence,CandidateList,DefaultStateInfo,DefaultInitVars,DefaultFlip,CheckTermination");
  CreateContainerTrigger("DefaultProceduresW","LitOccurence,CandidateList,DefaultStateInfo,DefaultInitVars,DefaultFlipW,CheckTermination");
...
void CheckTermination() {
  // +ANTON: this looks like a bug to me
  ...
  //  }
  //}
  bSolutionFound = (bWeighted) 
    ? (iSumFalseWeight <= iTargetWeight)
    : (iNumFalse <= iTarget);
  // -ANTON
}
